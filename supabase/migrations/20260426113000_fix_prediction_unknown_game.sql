-- Ensure prediction bets are accepted by place_bet in all environments.
...
BEGIN
  ...
  IF _game NOT IN ('dice', 'coinflip', 'limbo', 'chicken', 'plinko', 'pump', 'snakes', 'moles', 'prediction') THEN
