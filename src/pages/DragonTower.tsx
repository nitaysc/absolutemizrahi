...
const CONFIG: Record<Difficulty, { tiles: number; eggs: number; step: number; tone: string }> = {
  ...
  medium: { tiles: 3, eggs: 1, step: 1.485, tone: "border-sky-400 bg-sky-500/15 text-sky-300" },
  hard:   { tiles: 2, eggs: 1, step: 1.98,  tone: "border-amber-400 bg-amber-500/15 text-amber-300" },
  expert: { tiles: 3, eggs: 2, step: 2.97,  tone: "border-orange-400 bg-orange-500/15 text-orange-300" },
  master: { tiles: 4, eggs: 3, step: 3.96,  tone: "border-rose-400 bg-rose-500/15 text-rose-300" },
};
